...
* The version of vcpkg that is bundled with GitHub Actions runners does not have this feature yet. Ensure you are using vcpkg with [commit SHA 8f3e8d6](https://github.com/microsoft/vcpkg/commit/8f3e8d6e95c7f91edea60c47a7d1414ab5ca9492) or later (merged on 2023-06-26).
