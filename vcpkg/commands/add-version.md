...
Processes all the ports in the [built-in](..\maintainers\registries.md#built-in-registries) `ports` directory. If this option is used together with a port name, a warning is issued.
